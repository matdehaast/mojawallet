...
const Account: NextPage<AccountCardProps> = ({ account }) => {
  const accountList: AccountDetails[] = [account, account, account]
...
Account.getInitialProps = async (ctx) => {
  let id = ctx.query.id
  // TODO: Get account by account id above and pass that as a prop to the accounts page. Also get transactions while you're at it.
  let account
